...
and write summaries''')
tf.app.flags.DEFINE_integer('dot_freq', 10, '''Steps taks to print dot in console''')
...
time''')
tf.app.flags.DEFINE_integer('decay_step0', 80000, '''At which step to decay the learning rate''')
tf.app.flags.DEFINE_integer('decay_step1', 120000, '''At which step to decay the learning rate''')


## The following flags define hyper-parameters modifying the training network
tf.app.flags.DEFINE_integer('save_checkpoint_intervals', 5000, '''How many residual blocks do you want''')
