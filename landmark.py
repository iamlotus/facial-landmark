...
def _train_input_fn():
    ...
    return input_fn(record_file="data/tfrecords/train", batch_size=32, num_epochs=50, shuffle=True)


def _eval_input_fn():
    """Function for evaluating."""
    return input_fn(
        record_file="data/tfrecords/validate",
        batch_size=2,
        num_epochs=1,
        shuffle=False)
...
def _predict_input_fn():
    ...
    return input_fn(
        record_file="data/tfrecords/test",
        batch_size=2,
        num_epochs=1,
        shuffle=False)
...
def main(unused_argv):
    ...
    estimator = tf.estimator.Estimator(
        model_fn=cnn_model_fn, model_dir="logs/train")
    ...
    if mode == tf.estimator.ModeKeys.TRAIN:
        ...
        estimator.export_savedmodel('logs/saved_model', serving_input_receiver_fn)
